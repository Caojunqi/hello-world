...
import chessai.controller.searchengine.impl.AspirationSearchEngine;
...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        AbstractSearchEngine searchEngine = new AspirationSearchEngine(JiaBoardEvaluator.getInstance());
