 ...
 * 区别：不在置换表中插入叶子节点的估值
 */
public class TranspositionTableAlphaBetaSearchEngine_2 extends AbstractSearchEngine {
    public TranspositionTableAlphaBetaSearchEngine_2(IBoardEvaluator boardEvaluator) {
