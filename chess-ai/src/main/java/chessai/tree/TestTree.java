...
public class TestTree {
    ...
    public static Tree valueOf() {
        ...
        tree.addNode(Node.valueOf(111, 11, 2));
        tree.addNode(Node.valueOf(112, 11, 1));
        tree.addNode(Node.valueOf(12, 1));
        tree.addNode(Node.valueOf(121, 12, 6));
        tree.addNode(Node.valueOf(122, 12, 7));
        tree.addNode(Node.valueOf(2, 0));
        tree.addNode(Node.valueOf(21, 2));
        tree.addNode(Node.valueOf(211, 21, 3));
        tree.addNode(Node.valueOf(212, 21, 0));
        tree.addNode(Node.valueOf(22, 2));
        tree.addNode(Node.valueOf(221, 22, 5));
        tree.addNode(Node.valueOf(222, 22, 10));
        tree.addNode(Node.valueOf(3, 0));
        tree.addNode(Node.valueOf(31, 3));
        tree.addNode(Node.valueOf(311, 31, 2));
        tree.addNode(Node.valueOf(312, 31, 2));
        tree.addNode(Node.valueOf(32, 3));
        tree.addNode(Node.valueOf(321, 32, 12));
        tree.addNode(Node.valueOf(322, 32, 3));
        return tree;
    }
}
